...
class RedeemViewMode extends StatefulWidget {
  const RedeemViewMode({super.key});

  @override
  State<RedeemViewMode> createState() => _RedeemViewModeState();
}

class _RedeemViewModeState extends State<RedeemViewMode> {
  @override
  void initState() {
