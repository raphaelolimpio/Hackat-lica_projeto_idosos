...
class RedeemproductViewMode extends StatefulWidget {
  const RedeemproductViewMode({super.key});

  @override
  State<RedeemproductViewMode> createState() => _RedeemproductViewModeState();
}

class _RedeemproductViewModeState extends State<RedeemproductViewMode> {
  @override
  void initState() {
